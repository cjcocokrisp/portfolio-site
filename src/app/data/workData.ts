const workData = {
    ...
    "1": {
        ...
        "imgs": [
            ...
            ["myopro.png", 1500, 1000, "Myopro 2 Device"]
        ],
    ...
    "2": {
        ...
        "text": [
                 "Provided information about low cost devices and internet to help local residents in need get access to technology.",
                 "Taught basic digital literacy training to help combat the digital divide.",
                 "Other work for the city included, planning and helping run local recreation programs and mathematics tutoring."
        ],
        "imgs": [
                  ["cityofeverett.png", 587, 587, "City of Everett Logo"]
        ],
        "background_colors": ["#46822C", "#3E7327"] 
    }
}
